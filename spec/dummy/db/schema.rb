...
ActiveRecord::Schema.define(version: 20_150_421_093_311) do
  ...
  add_index 'friendly_id_slugs', %w[slug sluggable_type], name: 'index_friendly_id_slugs_on_slug_and_sluggable_type', unique: true, using: :btree
